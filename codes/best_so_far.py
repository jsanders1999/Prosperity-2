    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            if product == "STARFRUIT":
                ...
                bound2_buy = -3.5
                cutoff_sell = 6
                cutoff_buy = 0 #but 1 is sensible
...
def trade_constant_two_levels(product, orders, position, accteptable_price, position_limit, bound1, bound2, cutoff):
    buy_amount = position_limit - position
    sell_amount = position_limit + position
