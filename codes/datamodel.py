#!/usr/bin/env python
"""
Code prodived by IMC Trading for the Prosperity Game
Object model for the Prosperity Game

The object model is defined in this file. It contains the following classes:
- Listing
...
This code should not be changed. It is used by the game engine to interact with the traders.
"""
